...
public class PizzaWoogy extends Pizza {
    ...
    public PizzaWoogy(double calories, String name, double price, int size, boolean italianCrust, boolean extraCheese) {
        super(calories, name, price);
        this.size = size;
    ...
    public String toString() {
        return String.format(Locale.US, "PizzaWoogy[name=%s, size=%d, " +

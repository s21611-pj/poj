...
public class PizzaDeluxe extends Pizza {
    ...
    public PizzaDeluxe(double calories, String name, double price, int size, boolean italianCrust, boolean extraCheese) {
        super(calories, name, price);
        this.size = size;
    ...
    public String toString() {
        return String.format(Locale.US, "PizzaDeluxe[name=%s, size=%d, " +
